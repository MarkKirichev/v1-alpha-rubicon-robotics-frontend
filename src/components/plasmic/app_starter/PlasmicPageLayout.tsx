...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: jzaBbU7EBDz/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: HSz303NDJcD/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: CD-pWovB2Zo/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__k58Hz)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
        const __composite = [{ path: null, name: null }];
        __composite["0"]["path"] = `/v1-frontend-rubicon-robotics`;
    ...
    >
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx =>
              true ? (
                <div
                  className={classNames(projectcss.all, sty.freeBox___40ESw)}
                >
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg__bH0Xn)}
                    role={"img"}
                  />
                </div>
              ) : null
      ...
      >
        <ph.DataCtxReader>
          {$ctx =>
            true ? (
              <div className={classNames(projectcss.all, sty.freeBox__glsye)}>
                {p.renderPlasmicSlot({
                  defaultContents: (
                    <section
                      className={classNames(projectcss.all, sty.section__evKCu)}
                    >
                      <h1
                        className={classNames(
                          projectcss.all,
